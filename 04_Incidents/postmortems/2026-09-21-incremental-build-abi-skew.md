...
`e9e27b0` 3.67 %), because those builds were incremental too. The tell was that a **fresh clean build** of the
same tree behaved completely differently. Only after `meson compile --clean` did the picture become consistent.
