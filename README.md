...
**Documentation version 1.9** · source commit `679c0c1` · last audited phase **6** · machine-readable metadata in
...
- **Commit:** `679c0c1` · **working tree:** clean · **build:** clean (`meson compile --clean` then full build),
